...
def train(args):
  for num_model in range(args.num_models):
    ...
    print '\nModel: ' + str(num_model + 1) + '    LR: ' + str(args.lr) + '    Weight Decay: ' + str(args.weight_decay)
    ...
    save_image(style_model.output_image, args.image_size, args.save_dir, args.lr, args.weight_decay)
